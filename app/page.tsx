...
// Dynamic import for NoSSR component
...
export default function TableConverter() {
  ...
  const handleSampleData = () => {
    const sample =
      sampleData[selectedFormat as keyof typeof sampleData] || sampleData.csv;
  ...
  const handleCopy = async (format: string) => {
    ...
    try {
      ...
      toast({
        ...
        } format has been copied successfully`,
      });
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div
                className={
                  isTableExpanded
                    ? "space-y-6"
                    : "grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-12"
                }
              >
                {/* Left Panel - Input/Preview */}
                <Card
                  className={`card-enhanced hover-lift animate-slide-up ${
                ...
                >
                  ...
                  <CardContent
                    className={`p-8 ${
                      isTableExpanded
                        ? "h-[calc(100%-6rem)] overflow-hidden"
                        : ""
                    } custom-scrollbar`}
                  >
                    <Tabs value={activeTab} onValueChange={handleTabChange}>
                      ...
                      <TabsContent
                        ...
                        className={`space-y-8 mt-0 ${
                          isTableExpanded ? "h-[calc(100%-5rem)]" : ""
                        }`}
                      >
                        <PreviewPanel
                          tableData={tableData}
